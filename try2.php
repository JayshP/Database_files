...
if($op[$j][2]=='d')
{
		...
		$sql121="select j.dept,z.id from dept_info j,(".$x.") as z where z.dept_id=j.dept_no";
		//echo "<br>".$sql121."<br>";
...
//echo "".$y." ------------";
$sql22="select z.id,".$y." from personal p,(".$sqlp.") as z where z.id=p.id";
test2($arr,$sql22);
...
$sql22="select z.id,".$y." from hostel_info h,(".$sqlp.") as z where z.id=h.id";
test2($arr,$sql22);
?>
</fieldset>
<?php	
...
$sql22="select z.id,x.club from clubs_details x,(".$sql2.") as z where z.club_id=x.club_id";
//echo $sql22;
test2($arr,$sql22);
//echo "----".$sql22."---";
?>
...
if($op[$j][0]=='c')
{
	...
	if($op[$j][2]=='a')
	{
		$x="select c.activity_id,z.id from cultural_act c,(".$sqlp.") as z where z.id=c.id";
		$sql121="select a.act,z.id from activity a,(".$x.") as z where z.activity_id=a.act_id";
	...
	if($op[$j][2]=='e')
	{
		$x="select c.event_id,z.id from cultural_act c,(".$sqlp.") as z where z.id=c.id";
		$sql22="select e.event,z.id from e_act e,(".$x.") as z where z.event_id=e.e_id";
	...
	if($op[$j][2]=='p')
	{
		...
		$sql123="select p.part,z.id from p_act p,(".$x.") as z where z.part_id=p.p_id";
...
if($op[$j][0]=='g')
{
	...
	if($op[$j][2]=='g')
	{
		...
		$sql121="select g.game,z.id from game_id g,(".$x.") as z where z.game_id=g.g_id";
	...
	if($op[$j][2]=='e')
	{
		...
		$sql122="select e.event,z.id from e_game e,(".$x.") as z where z.event_id=e.e_id";
	...
	if($op[$j][2]=='p')
	{
		...
		$sql123="select p.part,z.id from p_game p,(".$x.") as z where z.part_id=p.p_id";
